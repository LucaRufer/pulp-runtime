...
#define ARCHI_CLIC_ADDR             ( ARCHI_DORMOUSE_PERIPHERALS_ADDR + ARCHI_CLIC_OFFSET )
#define ARCHI_INSTR_ERR_ADDR        ( ARCHI_DORMOUSE_PERIPHERALS_ADDR + ARCHI_INSTR_ERR_OFFSET )
#define ARCHI_DATA_ERR_ADDR         ( ARCHI_DORMOUSE_PERIPHERALS_ADDR + ARCHI_DATA_ERR_OFFSET )
#define ARCHI_SHADOW_ERR_ADDR       ( ARCHI_DORMOUSE_PERIPHERALS_ADDR + ARCHI_SHADOW_ERR_OFFSET )
